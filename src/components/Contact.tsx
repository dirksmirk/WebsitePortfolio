            ...
            {isSubmitted && (
              <div className="absolute inset-0 bg-card/95 backdrop-blur-sm rounded-lg flex items-center justify-center z-10 animate-fade-in">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-primary mb-2">Thanks for getting in touch!</h3>
                  <p className="text-muted-foreground">I'll get back to you as soon as possible.</p>
                </div>
              </div>
            )}

            {/* Form content with blur effect when submitted */}
            <div className={`transition-all duration-300 ${isSubmitted ? 'blur-sm' : ''}`}>
